...
export const MULTIPLE_CHOICE_SAMPLE = [
  {
    id: 1,
    word: "억까",
    options: ["부당하게 불이익을 당하는 것", "억지로 웃는 것", "억울해서 우는 것", "크게 화를 내는 것"],
    answer: "부당하게 불이익을 당하는 것",
  },
  {
    id: 2,
    word: "갓생",
    options: ["운이 좋은 인생", "계획적이고 알차게 사는 삶", "남에게 의지하는 삶", "즉흥적으로 사는 삶"],
    answer: "계획적이고 알차게 사는 삶",
  },
  {
    id: 3,
    word: "알잘딱깔센",
...
export const INITIAL_SOUND_SAMPLE = [
  { id: 101, initialSound: "ㅇㄲ", hint: "부당하게 불이익을 당하는 것", answer: "억까" },
...
export const SUBJECTIVE_SAMPLE = [
  ...
  { id: 203, question: "'너무 열심히 산다'는 뜻으로 쓰는 신조어는?", description: "'갓' 으로 시작합니다", answer: "갓생" },
];
